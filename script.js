...
const botaoPausePLay = document.querySelector('.app__card-primary-butto-icon');
...
function iniciarOuPausar() {
    ...
    botaoPausePLay.setAttribute('src', '/imagens/pause.png');
}

function zerar() {
    clearInterval(intervaloId);
    iniciarOuPausarBt.textContent = "Começar";
    botaoPausePLay.setAttribute('src', '/imagens/play_arrow.png');
    intervaloId = null;
}
